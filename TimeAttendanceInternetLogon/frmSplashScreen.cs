            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        pvtbytCompress = (byte[])clsISUtilities.DynamicFunction("Logon_New_User_TimeAttendance", objParm);
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                string strPath = AppDomain.CurrentDomain.BaseDirectory + "TimeAttendanceInternetMain.dll";
