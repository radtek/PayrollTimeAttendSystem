...
namespace InteractPayroll
{
    public partial class frmPayrollMain : Form
    {
        ...
        public frmPayrollMain()
        {
            ...
            MainToolStrip.Renderer = new CustomMenuStriplRenderer();
        }

        private void frmPayrollMain_Load(object sender, System.EventArgs e)
        {
            try
            {
                //Get Data From Logon
                ...
                clsISUtilities = new clsISUtilities(this,"busPayrollMain");
                ...
                if (AppDomain.CurrentDomain.GetData("AccessInd").ToString() == "S")
                {
                    ...
                    this.paymentOptionsToolStripMenuItem.Visible = true;
                ...
                {
                    this.paymentOptionsToolStripMenuItem.Visible = false;
                    this.changeEmployeeTypeToolStripMenuItem.Visible = false;
                    ...
                    this.resetEmployeeTakeOnToolStripMenuItem.Visible = false;
                ...
                if (AppDomain.CurrentDomain.GetData("UserCompanyToLoad").ToString() == "N")
                {
                    this.loadNewDemoRuntoolStripSeparator.Visible = false;
                    this.loadNewDemoRunToolStripMenuItem.Visible = false;
                }
        ...
        public void Load_Companies()
        {
            ...
            if (this.companytoolStripComboBox.Items.Count > 0)
            {
        ...
        public void Menu_Click(ToolStripMenuItem mniMenuItem)
        {
            try
            {
                if (mniMenuItem.DropDownItems.Count == 0)
                {
                    ...
                    {
                         case "loadNewDemoRunToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "LoadNewDemoRun.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmLoadNewDemoRun");

                            break;

                        case "chooseFingerprintReadertoolStripMenuItem":
                         ...
                         case "changeEmployeeTypeToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "ConvertEmployeeType.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmConvertEmployeeType");
                        ...
                        case "rosterToolStripMenuItem":
                         ...
                         case "shiftScheduleToolStripMenuItem":
                        ...
                        case "employmentTaxIncentiveToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "RptEti.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmRptEti");

                            break;
                            
                        case "employmentTaxIncentiveRunToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "EtiRun.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmEtiRun");
                       ...
                       case "salaryWageIncreaseToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "SalaryWageIncrease.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmSalaryWageIncrease");

                            break;

                        case "batchDeductionToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "BatchEarning.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmBatchEarning");

                            break;

                        case "batchEarningToolStripMenuItem":
                        ...
                        case "eFilingToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "EasyFile.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmEasyFile");
                        ...
                        case "rptleaveCalculatedTimeSheetToolStripMenuItem":
                        ...
                        case "paymentOptionsToolStripMenuItem":
                        ...
                        case "employeeEarningDeductLinkToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "EarningDeductionBatch.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmEarningDeductionBatch");

                            break;

                        case "createBankPaymentFileToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "PaymentFiles.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmPaymentFiles");
                        ...
                        case "companyToolStripMenuItem":
                            ...
                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "Company.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmCompany");
                        ...
                        case "earningToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "Earning.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmEarning");

                            break;

                        case "deductionToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "Deduction.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmDeduction");
                        ...
                        case "normalLeaveSickLeaveToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "NormalSickLeave.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmNormalSickLeave");

                            break;

                        case "leaveTypeToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "LeaveType.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmLeaveType");
                        ...
                        case "employeeToolStripMenuItem":
                            ...
                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "Employee.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmEmployee");
                        ...
                        case "leaveAuthorisationToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "LeaveAuthorisation.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmLeaveAuthorisation");

                            break;

                        case "leaveToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "LeaveProcess.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmLeaveProcess");
                        ...
                        case "payrollTotalsToolStripMenuItem":

                            obj = new object[1];
                            obj[0] = Convert.ToInt64(AppDomain.CurrentDomain.GetData("CompanyNo"));
                            
                            string strBusyWagesSalaryRun = (string)clsISUtilities.DynamicFunction("Check_If_Busy_Wages_Salary_Run", obj, false);

                            if (strBusyWagesSalaryRun == "Y")
                            {
                                AppDomain.CurrentDomain.SetData("RunType", "P");

                                pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "PayrollAnalysis.dll";
                                pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                                pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmPayrollAnalysis");
                            }
                            else
                            {
                                frmNotBusyWithRun frmNotBusyWithRun = new frmNotBusyWithRun();
                        ...
                        case "employeeLeaveTakeOnToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "EmployeeLeaveTakeOn.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmEmployeeLeaveTakeOn");

                            break;

                        case "employeeLeaveActivationToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "EmployeeLeaveTakeOnActivate.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmEmployeeLeaveTakeOnActivate");
                        ...
                        case "rptIRP5ToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "RptIRP5.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmRptIRP5election");
              
                            break;

                        case "rptPayslipToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "RptPaySlip.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmRptPaySlipSelection");

                            break;
                      
                        case "rptEarningDeductionToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "RptEarningsDeductions.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmRptEarningsDeductionsSelection");

                            break;

                        case "rptskillsDevelopmentLevyToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "RptSkillsDevelopmentLevy.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmRptSkillsDevelopmentLevySelection");

                            break;

                        case "rptLeaveToolStripMenuItem":

                            pvtstrPath = AppDomain.CurrentDomain.BaseDirectory + "RptLeave.dll";
                            pvtAssembly = System.Reflection.Assembly.LoadFile(pvtstrPath);
                            pvtlateBoundObj = pvtAssembly.CreateInstance("InteractPayroll.frmRptLeaveSelection");
                        ...
                        case "iRP5ToolStripMenuItem":

                            MessageBox.Show("Menu Option Unavailable at present");
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            && pvtForm.Name != "frmPasswordChange")
                            {
                                ...
                                lblHeader.Font = new System.Drawing.Font("Microsoft Sans Serif", 12.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        ...
        private void companytoolStripComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (companytoolStripComboBox.SelectedIndex > -1)
            {
                ...
                if (AppDomain.CurrentDomain.GetData("AccessInd").ToString() != "S")
                {
                    bool blnPrevVisibleIsSeperator = true;
                        ...
                        if (tsMenuItem.GetType().Name == "ToolStripMenuItem")
                        {
                            ...
                            for (int intItem1Count = 0; intItem1Count < tsMenuItem.DropDownItems.Count ; intItem1Count++)
                            {
                                if (tsMenuItem.DropDownItems[intItem1Count].GetType().Name == "ToolStripMenuItem")
                                {
                                    ...
                                    {
                                        if (tsToolStripMenuItem1.Name == "paymentOptionsToolStripMenuItem"
                                        | tsToolStripMenuItem1.Name == "resetEmployeeTakeOnToolStripMenuItem")
                                        {
                                            if (pvtDataSet.Tables["Company"].Rows[this.companytoolStripComboBox.SelectedIndex]["COMPANY_ACCESS_IND"].ToString() != "S")
                                            {
                                ...
                                else
                                {
                                    if (tsMenuItem.DropDownItems[intItem1Count].GetType().Name == "ToolStripSeparator")
                                    {
                                        ...
                                        if (tsToolStripSeparator1.Name == "toolStripSeparator2"
                                            | tsToolStripSeparator1.Name == "toolStripSeparator3")
                                        {
                                            if (pvtDataSet.Tables["Company"].Rows[this.companytoolStripComboBox.SelectedIndex]["COMPANY_ACCESS_IND"].ToString() != "S")
                                            {
        ...
        private void MdiChild_ButtonClose_MouseEnter(object sender, EventArgs e)
        {
            Button myButton = (Button)sender;
            myButton.BackColor = Color.Red;
        }

        private void MdiChild_ButtonClose_MouseLeave(object sender, EventArgs e)
        {
            Button myButton = (Button)sender;
        ...
        private void tmrMenuClick_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if (strMenuDesc == "backupDatabaseToolStripMenuItem")
                        {
                            Menu_Click(this.backupDatabaseToolStripMenuItem);
                        }
                    }
                }
            }
        ...
        {
            this.btnClose.BackColor = Color.Silver;
        }
