...
namespace InteractPayroll
{
    public class clsISUtilities
    {
        ...
        private string pvtstrFunctionName = "";
        ...
        public clsISUtilities(Form parParentForm,string BusinessObjectName)
        {
                        ...
                        foreach (DataGridViewColumn myColumn in myDataGridView.Columns)
                        {
                            if (myColumn is DataGridViewCalendarColumn)
                            {
                                if (myDataGridViewDateTimePicker == null)
                                {
                                    ...
                                    {
                                        System.Windows.Forms.MessageBox.Show("AppDomain.CurrentDomain.GetData - DateFormat ERROR\nFix To Continue.");
                                        return;
                                    }
            ...
            if (AppDomain.CurrentDomain.GetData("URLPath").ToString() != "")
            {
                ...
                {
                    System.Windows.Forms.MessageBox.Show("Error Creating URL - WebService Settings");
                }
            }
            else
            {
        ...
        public void Set_WebService_Timeout_Value(int TimeoutValueInMilliSeconds)
        {
            if (AppDomain.CurrentDomain.GetData("URLPath").ToString() != "")
            {
                ...
                {
                    CustomMessageBox.Show("WebService_Timeout Value Cannot be set because Web busDynamicService IS NULL.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
                ...
                if (parstrIncomeTaxRefNo.Length == 10)
                {
                        ...
                        | parstrIncomeTaxRefNo.Substring(0, 1) == "9")
                    {
                        if (parstrIncomeTaxRefNo != "0000000000")
                        {
                            ...
                            if (Double.TryParse(parstrIncomeTaxRefNo, out dblResult) == true)
                            {
        ...
        public int eFiling_SDL_Ref_No(string parstrSDLRefNO)
        {
            ...
            else
            {
                if (parstrSDLRefNO.Length == 9)
                {
                    ...
                    if (Double.TryParse(parstrSDLRefNO, out dblResult) == true)
                    {
        ...
        public int eFiling_UIF_Ref_No(string parstrUIFRefNO)
        {
            ...
            else
            {
                if (parstrUIFRefNO.Length == 9)
                {
                    ...
                    if (Double.TryParse(parstrUIFRefNO, out dblResult) == true)
                    {
        ...
        private void Initialise_Classes_DataSet()
        {
            ...
            //2017-10-11
            DataTable.Columns.Add("NO_COMMAS_IND", typeof(String));
        ...
        private void Show_Write_Errors(string parstrExceptionError)
        {
            ...
            & AppDomain.CurrentDomain.GetData("KillApp").ToString() != "Y")
            {
                ...
                {
                    CustomMessageBox.Show(parstrExceptionError,
                            "Error",
        ...
        public double Convert_Time_To_Decimal(int parintTimeInMinutes)
        {
            int intFieldHH;
            double dblFieldMM;
            ...
            double dblReturnValue = Convert.ToDouble(intFieldHH) + dblFieldMM;
            ...
            try
            {
                ...
                else
                {
                    if (e.KeyChar == (char)13)
                    {
                        ...
                        {
                            myTextBox.Text = Convert.ToDouble(0).ToString(strFormat);

                        }
                        else
                        {
                            myTextBox.Text = Convert.ToDouble(myTextBox.Text).ToString(strFormat);
                        }
                    }
                    else
                    {
        ...
        public void Set_Form_For_Edit(bool blnNew)
        {
            ...
            DataView DataView = new System.Data.DataView(pvtDataSet.Tables["Control"], "CONTROL_TYPE <> 'O' OR NO_COMMAS_IND = 'Y'", "TABINDEX1,TABINDEX2,TABINDEX3,TABINDEX4,TABINDEX5,TABINDEX6", DataViewRowState.CurrentRows);
            ...
            for (int intRow = 0; intRow < DataView.Count; intRow++)
            {
                ...
                if (DataView[intRow]["DATABOUND"].ToString() == "Y")
                {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        CustomMessageBox.Show("ERROR","Error",MessageBoxButtons.OK,MessageBoxIcon.Error);
                                    }
                                }
                            }
                        }
                    ...
                    else
                    {
                        ...
                        //else
                        //{
                        //    if (DataView[intRow]["NO_COMMAS_IND"].ToString() == "Y")
                        //    {
                        //        if (myControl.Text.Trim().IndexOf(",") > -1)
                        //        {
        ...
        public int DataBind_Save_Check()
        {
            ...
            DataView DataView = new System.Data.DataView(pvtDataSet.Tables["Control"], "REQUIRED_IND IN ('Y','E') OR NOT NUMBER_DECIMALS IS NULL OR SPECIAL_ADDR_FIELD_IND = 'Y' OR EITHER_OR_IND = 'Y' OR NO_COMMAS_IND = 'Y'" + strFilter, "TABINDEX1,TABINDEX2,TABINDEX3,TABINDEX4,TABINDEX5,TABINDEX6", DataViewRowState.CurrentRows);
                            ...
                            | DataView[intRow]["SPECIAL_FIELD_GROUP"].ToString() == "2"))
                        {
                            if (myControl.Name == myLinkedControl1.Name)
                            {
                                if (DataView[intRow]["REQUIRED_IND"].ToString() == "Y")
                                {
                                    ...
                                    CustomMessageBox.Show(DataView[intRow]["REQUIRED_MESSAGE"].ToString(), "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            ...
                            || DataView[intRow]["SPECIAL_FIELD_GROUP"].ToString() == "4")
                            {
                                ...
                                if (myLinkedControl1.Text == "")
                                {
                                    if (myControl.Name == myLinkedControl1.Name)
                                    {
                                        ...
                                        CustomMessageBox.Show("Enter Street Name / Farm Name.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                ...
                                {
                                    if (myLinkedControl1.Text.IndexOf(",") > -1)
                                    {
                                        //Other - Added Dynamically (If Row Exists then Error)
                                        if (DataView[intRow]["TAB_CONTROL_HANDLE"] != System.DBNull.Value)
                                        {
                                        ...
                                        CustomMessageBox.Show("Street Name / Farm Name Cannot have a Comma.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                ...
                                & myLinkedControl3.Text == "")
                                {
                                    if (myControl.Name == myLinkedControl2.Name)
                                    {
                                        ...
                                        CustomMessageBox.Show("Enter Suburb / District or City / Town.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                ...
                                {
                                    if (myLinkedControl2.Text.IndexOf(",") > -1
                                    ||  myLinkedControl3.Text.IndexOf(",") > -1)
                                    {
                                        if (myControl.Name == myLinkedControl2.Name)
                                        {
                                            //Other - Added Dynamically (If Row Exists then Error)
                                            ...
                                            CustomMessageBox.Show("Suburb / District or City / Town Cannot have a Comma.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                ...
                                else
                                {
                                    if (myControl.Name == myLinkedControl4.Name)
                                    {
                                        ...
                                        CustomMessageBox.Show("Enter a Valid Physical Address Code.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            ...
                            else
                            {
                                ...
                                if (myLinkedControl1.Text == "")
                                {
                                    if (myControl.Name == myLinkedControl1.Name)
                                    {
                                        ...
                                        CustomMessageBox.Show("Enter Postal Address Line 1.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                ...
                                else
                                {
                                    if (myControl.Name == myLinkedControl4.Name)
                                    {
                                        ...
                                        CustomMessageBox.Show("Enter a Valid Postal Address Code.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private int DataBound_ComboBox_Check(ComboBox parComboBox,DataRowView parDataViewRow,bool ShowErrorMessage)
        {
            ...
            & parComboBox.Enabled == true)
            {
                if (ShowErrorMessage == true)
                {
                    ...
                    CustomMessageBox.Show(parDataViewRow["REQUIRED_MESSAGE"].ToString(), "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            if (parTextBox.Enabled == true)
            {
                    ...
                    | parDataViewRow["REQUIRED_IND"].ToString() == "E")
                {
                    ...
                    else
                    {
                        ...
                        if (Double.TryParse(parTextBox.Text.Trim(), out dblResult) == false)
                        {
                        ...
                        {
                            if (Convert.ToDouble(parTextBox.Text.Trim()) == 0)
                            {
                                //ELR 2014-05-03
            ...
            if (parTextBox.Enabled == true)
            {
                    ...
                    else
                    {
                        ...
                        || parDataViewRow["SPECIAL_FIELD_GROUP"].ToString() == "4")
                        {
                            ...
                            else
                            {
                                ...
                                if (myLinkedControl3.Text.IndexOf(",") > -1)
                                {
                                    Paint_Parent_Marker((TextBox)myLinkedControl3, true);
                                }
                                else
                ...
                else
                {
                        ...
                        | parDataViewRow["REQUIRED_IND"].ToString() == "E")
                    {
                        ...
                        {
                            if (parDataViewRow["NO_COMMAS_IND"].ToString() == "Y")
                            {
                                if (parTextBox.Text.Trim().IndexOf(",") > -1)
                                {
                                    if (ShowErrorMessage == true)
                                    {
                                        if (parDataViewRow["TAB_CONTROL_HANDLE"] != System.DBNull.Value)
                                        ...
                                        CustomMessageBox.Show(parDataViewRow["REQUIRED_MESSAGE"].ToString().Replace(".","") + " with No Commas", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                            ...
                                            if (parDataViewRow["NO_COMMAS_IND"].ToString() == "Y")
                                            {
                                                if (parTextBox.Text.Trim().IndexOf(",") > -1)
                                                {
                                                    if (ShowErrorMessage == true)
                                                    {
                                                        ...
                                                        if (parDataViewRow["REQUIRED_MESSAGE"].ToString() == "")
                                                        {
                                                            CustomMessageBox.Show("No Commas Allowed.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                                        }
                                                        else
                                                        {
                                                            CustomMessageBox.Show(parDataViewRow["REQUIRED_MESSAGE"].ToString().Replace(".", "") + " with No Commas.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        public void DataBind_DataView_To_ComboBox(ComboBox parComboBox,string ValueMember,bool blnRequired,string RequiredMessage,bool blnEnableInEditMode)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Form DataView has Not been set");
                return;
            }
            ...
            if (DataView.Count == 0)
            {
                System.Windows.Forms.MessageBox.Show("ComboBox DataBind_ComboBox_Load Has Not Been Set for " + parComboBox.Name);
            }
            else
            {
                ...
                {
                    System.Windows.Forms.MessageBox.Show(ValueMember + " does Not Exist int pvtFormDataView");
                }
                else
                {
                    ...
                    if (blnRequired == true)
                    {
                        ...
                        {
                            System.Windows.Forms.MessageBox.Show("ComboBox " + parComboBox.Name + "Required Ind and Message Error");
                        }
                        else
                        {
                            if (blnEnableInEditMode == false)
                            {
                                System.Windows.Forms.MessageBox.Show("ComboBox " + parComboBox.Name + "Required=true and EnableInEditMode=false");
                            }
                            else
                            {
        ...
        private TabPage Create_Control_TabIndex_For_DataView(DataView DataView,Control myControl)
        {
            ...
            if (ctlParent is Form)
            {
                ...
                {
                    System.Windows.Forms.MessageBox.Show("Error in Create_Control_TabIndex_For_DataView for Control - " + myControl.Name);
                }
                else
                {
                    int intIndex = 0;
        ...
        public void DataBind_Control_Required_If_Enabled(Control parControl, string RequiredMessage)
        {
            ...
            if (DataView.Count == 0)
            {
                System.Windows.Forms.MessageBox.Show("ComboBox DataBind_Control_Required_If_Enabled Does Not Exist - " + parControl.Name);
            }
            else
            {
                if (DataView[0]["REQUIRED_IND"].ToString() == "Y")
                {
                    System.Windows.Forms.MessageBox.Show("ComboBox DataBind_Control_Required_If_Enabled CONFLICT - " + parControl.Name);
                }
                else
                {
        ...
        public void DataBind_Numeric_Field_Formatting(Control parControl, string FieldFormat)
        {
            ...
            if (DataView.Count == 0)
            {
                System.Windows.Forms.MessageBox.Show(parControl.Name + " Must be DataBound before DataBind_Numeric_Field_Length_Or_Formatting can Be Proceessed.");
            }
            else
            {
                if (DataView[0]["NUMBER_DECIMALS"] == System.DBNull.Value)
                {
                    System.Windows.Forms.MessageBox.Show(parControl.Name + " Needs to be Setup as Numeric.");
                }
                else
                {
                    if (FieldFormat.IndexOf("0") == -1)
                    {
                        System.Windows.Forms.MessageBox.Show(parControl.Name + " Field Format " + FieldFormat + " does NOT Have '9'");
        ...
        public void DataBind_Special_Field(Control parControl, int parLinkedGroup)
        {
            ...
            if (DataView.Count == 0)
            {
                System.Windows.Forms.MessageBox.Show(parControl.Name + " Must be DataBound before DataBind_Special_Field_Formatting can Be Proceessed.");
            }
            else
            {
        ...
        public void DataBind_Numeric_Field_SA_ID_Number(Control parControl)
        {
            ...
            if (DataView.Count == 0)
            {
                System.Windows.Forms.MessageBox.Show(parControl.Name + " Must be DataBound before DataBind_Numeric_Field_SA_ID_Number can Be Proceessed.");
            }
            else
            {
                if (DataView[0]["NUMBER_DECIMALS"] == System.DBNull.Value)
        ...
        public int SA_Identity_Number_Check(string ID)
        {
            ...
            if (ID.Length == 13)
            {
                try
                {
                    ...
                    if (Double.TryParse(ID, out dblResult) == true)
                    {
        ...
        private void Control_Paint(object sender, PaintEventArgs e)
        {
            ...
            DataView DataView = new System.Data.DataView(pvtDataSet.Tables["Control"], "CONTROL_PARENT_NAME = '" + myControl.Name + "' AND REQUIRED_IND IN ('Y','E') OR NOT NUMBER_DECIMALS IS NULL OR SPECIAL_ADDR_FIELD_IND = 'Y'  OR NO_COMMAS_IND = 'Y'" + strFilter, "", DataViewRowState.CurrentRows);
        ...
        public void DataBind_DataView_To_TextBox(TextBox parTextBox, string ValueMember, bool blnRequired, string RequiredMessage, bool blnEnableInEditMode)
        {
            ...
            if (blnRequired == true)
            {
                if (RequiredMessage.Trim() == "")
                {
                    System.Windows.Forms.MessageBox.Show("TextBox " + parTextBox.Name + "Required Ind and Message Error");
                }
                else
                {
                    if (blnEnableInEditMode == false)
                    {
                        System.Windows.Forms.MessageBox.Show("TextBox " + parTextBox.Name + "Required=true and EnableInEditMode=false");
                    }
                    else
                    {
        ...
        public void DataBind_DataView_NoCommas_To_TextBox(TextBox parTextBox, string ValueMember, bool blnRequired, string RequiredMessage, bool blnEnableInEditMode)
        {
            if (pvtFormDataView == null)
            {
                System.Windows.Forms.MessageBox.Show("Form DataView has Not been set");
        ...
        public void DataBind_DataView_Field_EFiling(TextBox parTextBox)
        {
            ...
            if (DataView.Count == 0)
            {
                System.Windows.Forms.MessageBox.Show(parTextBox.Name + " Must be DataBound before DataBind_DataView_Field_EFiling can Be Proceessed.");
            }
            else
            {
        ...
        public void DataBind_RadioButton_Default(RadioButton parRadioButton)
        {
            ...
            if (DataView.Count == 0)
            {
                System.Windows.Forms.MessageBox.Show("RadioButton '" + parRadioButton.Name + "' Needs to be Initialised in DataBind_DataView_To_RadioButton");
            }
            else
            {
        ...
        private void TextBox_TextChanged(object sender, EventArgs e)
        {
            if (pvtblnFormInEditMode == true)
            {
                if (pvtblnRemovingFormatting == false)
                {
                    ...
                    if (DataView[0]["NO_COMMAS_IND"].ToString() == "Y")
                    {
                        if (myTextBox.Text.Trim().IndexOf(",") > -1)
                        {
                            Paint_Parent_Marker(myTextBox, true);
                            return;
                        }
                    }
                            ...
                            if (DataView[0]["NUMBER_DECIMALS"].ToString() != "")
                            {
                                ...
                                if (DataView[0]["DATABOUND"].ToString() == "Y")
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            pvtFormDataView[DataViewIndex][DataView[0]["DATAVIEW_VALUEMEMBER"].ToString()] = Convert.ToDouble(myTextBox.Text.Trim());
                                        }
                                        else
                                        {
                                            pvtFormDataView[DataViewIndex][DataView[0]["DATAVIEW_VALUEMEMBER"].ToString()] = myTextBox.Text.Trim();
            ...
            if (myTextBox.Enabled == true)
            {
                ...
                if (DataView[0]["CONTROL_TYPE"].ToString() == "T")
                {
                    if (DataView[0]["NUMBER_DECIMALS"].ToString() != "")
                    {
                        ...
                        {
                            if (Convert.ToDouble(myTextBox.Text.Trim()) == 0)
                            {
                                blnPaint = true;
                            }
                        }
    ...
    public void Paint_Parent_Marker(Control parControl, bool parPaintControl)
        ...
        private void DataBind_Numeric_KeyPress(object sender, System.Windows.Forms.KeyPressEventArgs e)
        {
            ...
            double dblgMaxNumber = Convert.ToDouble(DataView[0]["MAX_NUMBER"]);
                ...
                & e.KeyChar < (char)58))
            {
                ...
                if (dblgMaxNumber != 0)
                {
                    ...
                    {
                        if (dblgMaxNumber < Convert.ToDouble(strNewNumericTextField))
                        {
                            e.Handled = true;
                            System.Console.Beep();
                            return;
        ...
        public void Re_DataBind_DataView(DataView parDataView)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("ReBind Error");
                return;
            }
        }
        ...
        public void DataBind_DataView_And_Index(Form myForm,DataView parDataView,string DataViewKeyFieldName)
        {
            ...
            if (myDataView.Count > 0)
            {
                System.Windows.Forms.MessageBox.Show("This Feature has Not been Included - Unhooking of Events need to Be Programmed");
                return;
            }
            ...
            {
                System.Windows.Forms.MessageBox.Show("DataView needs to have a Sort Field Set"); 
            }
        }
        ...
        public void DataBind_DataView_Record_Show()
        {
            ...
            if (pvtblnFormInEditMode == true)
            {
                System.Windows.Forms.MessageBox.Show("DataBind_DataView_Record_Show - Still In Edit Mode\nAction Canceled.");
                return;
            }
#endif
            //pvtDataSet.Tables["Control"].AcceptChanges();
            ...
            for (int intRow = 0; intRow < pvtDataSet.Tables["Control"].Rows.Count; intRow++)
            {
                if (pvtDataSet.Tables["Control"].Rows[intRow]["DATABOUND"].ToString() == "Y")
                {
                    ...
                    if (strValueMember == "")
                    {
                        System.Windows.Forms.MessageBox.Show("Control '" + strControlName + "' VALUEMEMBER HAS NOT Been Initialised\nAction Cancelled.");
                        return;
                    }
#endif
                                ...
                                if (pvtDataSet.Tables["Control"].Rows[intRow]["CONTROL_TYPE"].ToString() == "T")
                                {
                                    ...
                                    if (pvtFormDataView.Table.Columns[pvtDataSet.Tables["Control"].Rows[intRow]["DATAVIEW_VALUEMEMBER"].ToString()].DataType.ToString() == "System.String")
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (Double.TryParse(pvtFormDataView[DataViewIndex][pvtDataSet.Tables["Control"].Rows[intRow]["DATAVIEW_VALUEMEMBER"].ToString()].ToString(), out dblResult) == false)
                                            {
                                                //Not Number
                                                myTextBox.Text = pvtFormDataView[DataViewIndex][pvtDataSet.Tables["Control"].Rows[intRow]["DATAVIEW_VALUEMEMBER"].ToString()].ToString();
                                            }
                                            else
                                            {
                                                ...
                                                {
                                                    //Format
                                                    myTextBox.Text = Convert.ToDouble(pvtFormDataView[DataViewIndex][pvtDataSet.Tables["Control"].Rows[intRow]["DATAVIEW_VALUEMEMBER"].ToString()]).ToString(pvtDataSet.Tables["Control"].Rows[intRow]["NUMERIC_FIELD_FORMAT"].ToString());
                                                }
                                                else
                                                {
                                                    myTextBox.Text = pvtFormDataView[DataViewIndex][pvtDataSet.Tables["Control"].Rows[intRow]["DATAVIEW_VALUEMEMBER"].ToString()].ToString();
                                    ...
                                    else
                                    {
                                        ...
                                        myTextBox.Text = Convert.ToDouble(pvtFormDataView[DataViewIndex][pvtDataSet.Tables["Control"].Rows[intRow]["DATAVIEW_VALUEMEMBER"].ToString()]).ToString(strFormat);
                                    }
                                }
                                else
                                {
                    ...
                    else
                    {
                        if (pvtDataSet.Tables["Control"].Rows[intRow]["CONTROL_TYPE"].ToString() == "C")
                        {
                            ...
                            if (pvtDataSet.Tables["Control"].Rows[intRow]["DATAVIEW_VALUEMEMBER"] == System.DBNull.Value)
                            {
                                if (pvtDataSet.Tables["Control"].Rows[intRow]["DATABOUND"].ToString() == "Y")
                                {
                                    System.Windows.Forms.MessageBox.Show("There is No DataView Field Link to the ComboBox '" + strComboName + "'");
                                    return;
                                }
                            }
#endif
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        System.Windows.Forms.MessageBox.Show("Calender_TextChanged Error");
                                    }
                                }
                            }
                        }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    System.Windows.Forms.MessageBox.Show("Calender_Control_From_TextBox_Enable Error");
                                }
                            }
                        }
                    }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    System.Windows.Forms.MessageBox.Show("Calender_Control_From_TextBox_Disable Error");
                                }
                            }
                        }
                    }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    System.Windows.Forms.MessageBox.Show("Calender_Control_From_TextBox_SetVisible Error");
                                }
                            }
                        }
                    }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    System.Windows.Forms.MessageBox.Show("Calender_Control_From_TextBox_SetInvisible Error");
                                }
                            }
                        }
                    }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            System.Windows.Forms.MessageBox.Show("Error Creating");
                        }
                    }
                }
            }
            ...
            ref int parintOverTime2WeekTotal, ref int parintOverTime3WeekTotal)
        {
                ...
                & intDayNo < 6)
            {
                ...
                if (parintTotalDayHours > Convert.ToDouble(parDataView[parintRow]["TOTAL_DAILY_TIME_OVERTIME"])
                    & Convert.ToDouble(parDataView[parintRow]["TOTAL_DAILY_TIME_OVERTIME"]) != 0)
                {
            ...
            else
            {
                if (intDayNo == 6)
                {
                    ...
                    if (parDataView[parintRow]["SATURDAY_PAY_RATE_IND"].ToString() == ""
                        | Convert.ToDouble(parDataView[parintRow]["SATURDAY_PAY_RATE"]) == 0)
                    {
                        intTimeBreakDown = parintNormalTimeWeekTotal + parintTotalDayHours;
                    ...
                    else
                    {
                            ...
                            | parintNormalTimeWeekTotal > parintNormalTimeTotalBoundary)
                        {
                            ...
                            if (Convert.ToDouble(parDataView[parintRow]["SATURDAY_PAY_RATE"]) == Convert.ToDouble(parDataView[parintRow]["OVERTIME1_RATE"]))
                            {
                            ...
                            {
                                if (Convert.ToDouble(parDataView[parintRow]["SATURDAY_PAY_RATE"]) == Convert.ToDouble(parDataView[parintRow]["OVERTIME2_RATE"]))
                                {
                                ...
                                {
                                    if (Convert.ToDouble(parDataView[parintRow]["SATURDAY_PAY_RATE"]) == Convert.ToDouble(parDataView[parintRow]["OVERTIME3_RATE"]))
                                    {
                ...
                else
                {
                    ...
                    if (parDataView[parintRow]["SUNDAY_PAY_RATE_IND"].ToString() == ""
                        | Convert.ToDouble(parDataView[parintRow]["SUNDAY_PAY_RATE"]) == 0)
                    {
                        intTimeBreakDown = parintNormalTimeWeekTotal + parintTotalDayHours;
                    ...
                    else
                    {
                        ...
                        {
                            //Append to relevant OverTime Rate
                            if (Convert.ToDouble(parDataView[parintRow]["SUNDAY_PAY_RATE"]) == Convert.ToDouble(parDataView[parintRow]["OVERTIME1_RATE"]))
                            {
                                parintOverTime1 = parintTotalDayHours;
                                goto Calculate_Wage_Time_Breakdown_Continue;
                            }
                            ...
                            {
                                if (Convert.ToDouble(parDataView[parintRow]["SUNDAY_PAY_RATE"]) == Convert.ToDouble(parDataView[parintRow]["OVERTIME2_RATE"]))
                                {
                                    parintOverTime2 = parintTotalDayHours;
                                    goto Calculate_Wage_Time_Breakdown_Continue;
                                }
                                ...
                                {
                                    if (Convert.ToDouble(parDataView[parintRow]["SUNDAY_PAY_RATE"]) == Convert.ToDouble(parDataView[parintRow]["OVERTIME3_RATE"]))
                                    {
                                        parintOverTime3 = parintTotalDayHours;
                                        goto Calculate_Wage_Time_Breakdown_Continue;
                                    }
...
//2012-09-03 (Temp)
            ...
            {
                pvtParentForm.Cursor = Cursors.Default;
                CustomMessageBox.Show("Connection Failure", "Failure", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            catch (Exception ex)
            {
                ...
                if (fiFileInfo.Exists == true)
                {
                    ...
                    CustomMessageBox.Show("clsISUtilities Call " + pvtstrBusinessObjectName + "/" + FunctionName + " " + strError, "Failure", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
...
//#endif
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                System.Windows.Forms.MessageBox.Show("Control Not Catered for = " + myControl.Name);
                                            }
                                        }
                                    }
                                }
        ...
        public int WebService_Settings(System.Web.Services.Protocols.WebClientProtocol ws, string parWebServiceName)
        {
            ...
            {
                CustomMessageBox.Show("Web Service '" + parWebServiceName + "' URL Path '" + AppDomain.CurrentDomain.GetData("URLPath").ToString() + "' is Invalid.\n\nContact System Administrator.",
                    "Web Service Error",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Error);
        ...
        private void DynamicFunctionCompleted(object sender, localhost.DynamicFunctionCompletedEventArgs e)
        {
            ...
            catch (TargetInvocationException ex)
            {
                ...
                || ex.InnerException.Message.IndexOf("request failed with an empty response") > -1
                || ex.InnerException.Message.IndexOf("Server Unavailable") > -1)
                {
                    frmConnectionFailure frmConnectionFailure = new frmConnectionFailure();
